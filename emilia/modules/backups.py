...
def import_data(update, context):
	...
	if msg.reply_to_message and msg.reply_to_message.document:
		...
		try:
			...
			send_message(update.effective_message, tl(update.effective_message, "Telah terjadi kesalahan dalam import backup data!"), parse_mode="markdown")
			LOGGER.exception("An error when importing from data base!")
			return
...
def export_data(update, context):
	...
	f = open("{}-DB.backup".format(chat_id), "w")
	...
	try:
		...
		pass
	os.remove("{}-DB.backup".format(chat_id)) # Cleaning file
